...
import { BarChart3, Users, Bike, DollarSign, Bell } from 'lucide-react';
        ...
        <Card>
          <CardContent className="pt-6 space-y-4">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-brand-cream/70 text-sm font-medium mb-1">Signup Requests</p>
                <p className="text-3xl font-bold text-brand-cream">{stats.pendingApprovals}</p>
              </div>
